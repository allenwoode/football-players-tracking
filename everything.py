...
TARGET_VIDEO_PATH = f"{HOME}/final/8fd33_1.mp4"
...
# initiate annotators
base_annotator = BaseAnnotator(colors=COLORS, thickness=THICKNESS)

player_text_annotator = TextAnnotator(PLAYER_COLOR, text_color=Color(255, 255, 255), text_thickness=2)
goalkeeper_text_annotator = TextAnnotator(GOALKEEPER_COLOR, text_color=Color(255, 255, 255), text_thickness=2)
referee_text_annotator = TextAnnotator(REFEREE_COLOR, text_color=Color(0, 0, 0), text_thickness=2)
